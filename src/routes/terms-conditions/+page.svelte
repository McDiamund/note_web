...
<div class="container">
	...
	<div class="panel panel-right">
		<div class="content">
			...
			<p>
				These terms and conditions apply to the Note. app (hereby
				referred to as "Application") for mobile devices that was
				created by Treadway Designs LLC. (hereby referred to as "Service

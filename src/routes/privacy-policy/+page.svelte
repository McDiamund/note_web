...
<div class="container">
	...
	<div class="panel panel-right">
		<div class="content">
			...
			<p>
				This privacy policy applies to the Note. app (hereby referred to
				as "Application") for mobile devices that was created by
				Treadway Designs LLC. (hereby referred to as "Service Provider")
			...
			<p>
				...
				to Email Address, Location Data (Coarse Location), Advertising
				Data. The information that the Service Provider request will be
			...
			<p>
				...
				support@usenote.co and they will respond in a reasonable time.
			</p>
			...
			<div>
				...
				<p>
					...
					contact the Service Provider (support@usenote.co) so that
			...
			<br />
			<p>This privacy policy is effective as of 2025-12-10</p>
			...
			<p>
				...
				contact the Service Provider via email at support@usenote.co.
			</p>
			<br />
			<hr />
			<br />
